    ...
    <div className="w-full max-w-lg rounded-2xl bg-white shadow-xl border border-gray-100 overflow-hidden">
      ...
      <div className="p-8 text-center bg-white relative">
        ...
        <div className="flex flex-col items-center">
          <div className="w-20 h-20 flex items-center justify-center rounded-full bg-green-100 mb-4 shadow-sm">
        ...
        <div className="mt-8 bg-slate-50 rounded-xl p-6 border-2 border-slate-100 relative text-center shadow-sm">
      ...
      <div className="bg-gray-50 p-8 border-t border-gray-100">
        ...
        {/* ✅ Action Grid: Side-by-side on larger screens */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Using the green styling you liked, but making it fit the grid height */}
          <div className="bg-green-50 p-4 rounded-xl border border-green-200 shadow-sm flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10 mt-auto">
              ...
              <a
                href={`https://wa.me/8921837945?text=${encodeURIComponent(
