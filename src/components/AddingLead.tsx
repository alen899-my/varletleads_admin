...
const capacitySchema = z.number().min(1, { message: "Capacity must be at least 1" }).max(1500, { message: "Capacity cannot exceed 1500" });
 ...
 const validateStep5 = () => {
  ...
  const FileUploadBlock = ({ label, name, accept, file, setFormData, existingFileName }: { label: string, name: string, accept: string, file: any, setFormData: any, existingFileName: any }) => {
    // Typed useRef
...
">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, waitTime: e.target.value })}
                  className="input"
                />
              </div>
              ...
              <div className="md:col-span-1">
                ...
                <input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, mapsUrl: e.target.value })}
                  className="input"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, timing: e.target.value })}
                  className="input"
                />
              </div>
